    ...
    <svg className='svg-ui-icon-login' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xmlSpace="preserve">
      ...
      <g transform="translate(128 128) scale(0.72 0.72)">
      	<g transform="translate(-175.05 -175.05000000000004) scale(3.89 3.89)" >
        	...
        	<path d="M 77.433 67 c -1.104 0 -2 -0.896 -2 -2 v -6.347 c 0 -3.566 -2.902 -6.469 -6.469 -6.469 h -1.518 c -3.566 0 -6.469 2.902 -6.469 6.469 V 65 c 0 1.104 -0.896 2 -2 2 s -2 -0.896 -2 -2 v -6.347 c 0 -5.772 4.696 -10.469 10.469 -10.469 h 1.518 c 5.772 0 10.469 4.696 10.469 10.469 V 65 C 79.433 66.104 78.537 67 77.433 67 z" transform=" matrix(1 0 0 1 0 0) " strokeLinecap="round" />
        	<path d="M 68.205 79.333 c -1.104 0 -2 -0.896 -2 -2 v -1.852 c 0 -1.104 0.896 -2 2 -2 s 2 0.896 2 2 v 1.852 C 70.205 78.438 69.31 79.333 68.205 79.333 z" transform=" matrix(1 0 0 1 0 0) " strokeLinecap="round" />
        </g>
      </g>
    </svg>
    )
